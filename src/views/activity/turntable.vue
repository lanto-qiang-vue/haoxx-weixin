...
<div class="turntable">
	...
	<div class="intro">
		...
		<ul>
			...
			<li>3、抽中奖品后，请在24小时内，在“我的” - “我的奖品”列表中“点击领取”并正确填写收件地址等信息。如用户未在抽中奖品后的24小时内及时领取奖品，则奖品自动过期放弃；因错填漏填造成的奖品发放错误将由用户承担责任。</li>
			<li>4、奖品将于5个工作日内统一安排寄送，奖品仅限中国大陆地区寄送。</li>
			<li>5、奖品不可兑换现金，奖品以实物为准。</li>
		</ul>
	</div>
	...
	methods:{
		vaptcha(){
			window.vaptcha({
				...
				vid: '5d80a59ffc650fd878051e67', // 验证单元id
				type: 'embed', // 显示类型 点击式
