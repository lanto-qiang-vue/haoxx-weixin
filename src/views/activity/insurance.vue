...
export default {
	...
	methods:{
		toGo(){
			window.location.href= "https://camspro.cpic.com.cn/cams/TaiBaoApp/dist/#/product/buyInfoSeatBeltProductCar?pid=0&pEnsure=0&mid=10208&userName=106964&url="+ encodeURIComponent(window.location.href)
